...
class NonBPJSTab extends StatefulWidget {
  @override
  _NonBPJSTabState createState() => _NonBPJSTabState();
}

class _NonBPJSTabState extends State<NonBPJSTab> {
  ...
  Future<void> fetchParamedicList() async {
    final String url = 'http://103.165.218.182:8080/getAllParamedicIDnNameNonBPJSnMixed';
    try {
              ...
              child: scheduleList.isNotEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      title: Text('Paramedic Name: ${schedule['ParamedicName']}'),
                      subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Tanggal Mulai: ${schedule['StartTime1']}'),
                          Text('Tanggal Akhir: ${schedule['EndTime1']}'),
                          Text('Unit Layanan: ${schedule['ServiceUnitName']}'),
                        ],
                      ),
                    ),
                  );
