...
class RiwayatBerobatPage extends StatefulWidget {
  final Map<String, dynamic> patientData;

  RiwayatBerobatPage({required this.patientData});

  @override
  _RiwayatBerobatPageState createState() => _RiwayatBerobatPageState();
}

class _RiwayatBerobatPageState extends State<RiwayatBerobatPage> {
  ...
  Future<List<dynamic>> fetchRegistrationHistory(String medicalNo) async {
    String url =
        'http://avi.rsimmanuel.net/test/WebService/MobileWS2.asmx/PatientRegistrationHistory?AccessKey=AvcMblPat&MedicalNo=$medicalNo&ServiceUnitID=&ParamedicID=&DateStart=&DateEnd=';
    ...
    if (selectedEndDate != null && selectedStartDate != null) {
      ...
      url = 'http://avi.rsimmanuel.net/test/WebService/MobileWS2.asmx/PatientRegistrationHistory?AccessKey=AvcMblPat&MedicalNo=$medicalNo&ServiceUnitID=&ParamedicID=&DateStart=$newStartDate&DateEnd=$newEndDate';
    }
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Tipe Registrasi: ${registration['SRRegistrationType']}'),
                                ...
                                Text('Catatan: ${registration['DischargeNotes'] ?? 'Tidak ada'}'),
                              ],
                            ),
                          ),
                        );
