...
class ParamedicRepositoryImpl implements ParamedicRepository {
  final String baseUrl = "http://103.165.218.182:8080/getAllParamedicIDnNameNonBPJSnMixed";
  ...
  Future<List<Paramedic>> getDoctorsByPoli(String poliId) async {
    ...
    final response = await http.get(Uri.parse('http://103.165.218.182:8080/getParamedicByServiceUnit?serviceunitid=$poliId'));
    print(response.body);
    if (response.statusCode == 200) {
